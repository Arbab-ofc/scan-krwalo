...
const groups: Group[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      ["GET", "/api/v1/push-subscriptions/public-key", "Public", "OneSignal web push configuration."],
      ["POST", "/api/v1/push-subscriptions", "Authenticated", "Confirm OneSignal external user registration."],
      ["POST", "/api/v1/push-subscriptions/test", "Authenticated", "Send a test push notification."],
  ...
  },
  {
    ...
    endpoints: [
      ...
      ["POST", "/api/v1/admin/notifications/test-push", "Admin", "Send one OneSignal test push to every user."],
