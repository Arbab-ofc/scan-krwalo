...
const groups: Group[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      ["GET", "/api/v1/push-subscriptions/public-key", "Public", "Browser push VAPID public key."],
      ["POST", "/api/v1/push-subscriptions", "Authenticated", "Save or refresh browser push subscription."],
